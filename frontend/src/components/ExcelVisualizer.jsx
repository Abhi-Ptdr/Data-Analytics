  ...
  return (
    ...
    <div className="bg-white text-gray-900 font-sans mt-15">
      <div className="pt-10 pb-20">
        ...
        <section className="w-full bg-gray-50 p-10 rounded border border-gray-200 mt-10">
          <div className='max-w-7xl mx-auto md:px-16 lg:px-20 xl:px-24'>
            {/* Key Features */}
            <div id="key-features" className="max-w-4xl mx-auto text-center">
            ...
            <div className="mt-10 max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
              {[
                ...
                <div key={index} className="bg-white border border-gray-200 rounded-lg p-6 text-left">
                  ...
                  <h3 className="font-semibold text-gray-900 text-md mb-1">{feature.title}</h3>
        ...
        {/* Bottom Section */}
        <section className='max-w-7xl mx-auto px-6 sm:px-10 md:px-16 lg:px-20 xl:px-24 '>
          <div className="mt-24 max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between gap-10">
